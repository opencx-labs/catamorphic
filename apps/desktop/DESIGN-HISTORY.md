...
**Superseded in part:** sending state and plain-link chat presentation are governed
by [chat state](docs/chat-state.md) and [workspace interactions](docs/workspace-interactions.md).
