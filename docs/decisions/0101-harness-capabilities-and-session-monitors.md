...
- **Status:** Accepted; source retirement superseded by [0124](0124-session-artifacts.md)
- **Date:** 2026-09-07
...
their immutable source. Under ADR 0124, results remain with the retained session;
